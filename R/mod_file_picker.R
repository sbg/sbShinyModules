...
#'
#' @description UI function of the file picker Shiny module. It adds
...
#'  based on the specified `selection` mode ('single' or 'multiple'). The table
...
#'  Defaults to 10.
#' @param use_bslib_theme A logical value indicating if the modal's UI should
#'  be generated using the \code{bslib} package. If \code{FALSE} (the default),
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$table <- reactable::renderReactable({
      reactable::reactable(files_df,
        ...
        # Limit the number of characters displayed in a cell to 40
    ...
    # Show the paths for currently selected files
    ...
    # Add logic that will be triggered by clicking the Submit button
